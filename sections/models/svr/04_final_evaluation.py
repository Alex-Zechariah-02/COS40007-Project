...
for fname, title in [
    ("final_svr_metrics.csv", "Final SVR metrics"),
    ("baseline_vs_svr_summary.csv", "Baseline versus SVR summary"),
    ("expanded_model_comparison_metrics.csv", "Expanded model and baseline comparison"),
    ("expanded_baseline_vs_svr_delta.csv", "SVR improvement over baselines"),
