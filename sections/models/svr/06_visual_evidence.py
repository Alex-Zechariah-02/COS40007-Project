...
for fig, title, purpose, how, better, takeaway in featured:
    guided_figure(figure_path(fig), title, purpose, how, better, takeaway, "Featured figures are a guided subset. Use the full gallery below for all saved figures.")
...
if not registry.empty:
    show_detail_table(registry, "Detailed visual evidence registry")
