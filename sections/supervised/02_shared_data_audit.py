...
from src.ui_components import page_header, render_page_intro, render_page_discussion, show_table_with_guide, show_table, metric_cards, guided_figure, next_steps
...
tab_inventory, tab_preview, tab_visuals, tab_evidence = st.tabs(["Raw files", "Raw preview", "Audit figures", "Detailed evidence"])
