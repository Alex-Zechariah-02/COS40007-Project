...
from src.ui_components import page_header, render_page_intro, render_page_discussion, show_table, show_table_with_guide, show_detail_table, metric_cards, guided_figure, next_steps
...
tab_groups, tab_registry, tab_sources, tab_figures = st.tabs(["Feature groups", "Feature registry", "Source feature tables", "Figures"])
...
with tab_registry:
    if not reg.empty:
        show_table_with_guide(reg, "final_feature_registry.csv", "Final feature registry", max_rows=20)
